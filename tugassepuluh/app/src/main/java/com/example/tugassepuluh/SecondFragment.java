...
public class SecondFragment extends Fragment {
    ...
    private static final String YOUTUBE_VIDEO_ID_1 = "fxNoAx_Fpxg";
    private static final String YOUTUBE_VIDEO_ID_2 = "0uf6QUacVgs";
    private static final String YOUTUBE_VIDEO_ID_3 = "FuC8H8eXZFU";
    private static final String YOUTUBE_VIDEO_ID_4 = "lmuNabammwk";
